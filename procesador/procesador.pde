...
int move1=160;
int c2=12, c=12;
int fc0=255, fc1=255, fc2=255, fc3=255, fc4=255, fc5=255, fc6=255, fc7=255, fc8=255, fc9=255, fc10=255, fc11=255, fc12=255, fc13=255, fc14=255, fc15=255;
int fi0=255, fi1=255, fi2=255, fi3=255, fi4=255, fi5=255, fi6=255, fi7=255, fi8=255, fi9=255, fi10=255, fi11=255, fi12=255, fi13=255, fi14=255, fi15=255;
...
void draw() {
  ...
  if (op.equals("1")) {
    ...
    fill(fi0);
    text("Suma", (width/2)-138, (height/2)-435);
    fill(f4);
    //direccion
    ...
    fill(fi1);
    text("Potencia", (width/2)-138, (height/2)-423);
    fill(f12);
    //direccion
    ...
    fill(fi2);
    text("Suma", (width/2)-138, (height/2)-411);
    fill(f20);
    //direccion
    ...
    fill(fi3);
    text("MEMORIA", (width/2)-138, (height/2)-399);
    fill(f28);
    //direccion
    ...
    fill(fi4);
    text("RESET", (width/2)-138, (height/2)-387);
    fill(f36);
    //direccion
    ...
    fill(fi5);
    text("Suma", (width/2)-138, (height/2)-375);
    fill(f44);
    //direccion
    ...
    fill(fi6);
    text("Suma", (width/2)-138, (height/2)-363);
    fill(f52);
    //direccion
    ...
    fill(fi7);
    text("MEMORIA", (width/2)-138, (height/2)-351);
    fill(f60);
    //direccion
    ...
    fill(fi8);
    text("RESET", (width/2)-138, (height/2)-339);
    fill(f68);
    //direccion
    ...
    fill(fi9);
    text("Suma", (width/2)-138, (height/2)-327);
    fill(f76);
    //direccion
    ...
    fill(fi10);
    text("Suma", (width/2)-138, (height/2)-315);
    fill(f84);
    //direccion
    ...
    fill(fi11);
    text("MEMORIA", (width/2)-138, (height/2)-303);
    fill(f92);
    //direccion
    ...
    fill(fi12);
    text("FINALIZAR", (width/2)-138, (height/2)-291);
    fill(f100);
    //direccion
  ...
  if (op.equals("2")) {    
    ...
    fill(fi1);
    text("AND", (width/2)-138, (height/2)-423);
    fill(f12);
    //direccion
    text("00010001", (width/2)-x12-2, (height/2)+y12);
    //memoria
    ...
    fill(fi2);
    text("MEMORIA", (width/2)-138, (height/2)-411);
    fill(f20);
    //direccion
    ...
    fill(fi3);
    text("RESET", (width/2)-138, (height/2)-399);
    fill(f28);
    //direccion
    ...
    fill(fi4);
    text("NOT", (width/2)-138, (height/2)-387);
    fill(f36);
    //direccion
    ...
    fill(fi5);
    text("MEMORIA", (width/2)-138, (height/2)-375);
    fill(f44);
    //direccion
    text("00010100", (width/2)-x44-2, (height/2)+y44);
    //memoria
    ...
    fill(fi6);
    text("RESET", (width/2)-138, (height/2)-363);
    fill(f52);
    //direccion
    ...
    fill(fi7);
    text("Suma", (width/2)-138, (height/2)-351);
    fill(f60);
    //direccion
    ...
    fill(fi8);
    text("OR", (width/2)-138, (height/2)-339);
    fill(f68);
    //direccion
    ...
    fill(fi9);
    text("MEMORIA", (width/2)-138, (height/2)-327);
    fill(f76);
    //direccion
    ...
    fill(fi10);
    text("FINALIZAR", (width/2)-138, (height/2)-315);
    fill(f84);
    //direccion
    ...
    fill(fi3);
    text("División", (width/2)-138, (height/2)-399);
    fill(f28);
    //direccion
    text("00010011", (width/2)-x28-2, (height/2)+y28);
    //memoria
    fill(f70);
    text("0000000000000011", (width/2)+x70, (height/2)-y70+2);
    //registro ALU
    fill(f31);
    ...
    fill(fi4);
    text("Suma", (width/2)-138, (height/2)-387);
    fill(f36);
    //direccion
    ...
    //memoria
    fill(f62);
    text("0000000001101010", (width/2)+x62, (height/2)-y62);
    //registro ALU
    fill(f47);
    ...
    //GMemoria
    fill(m1);
    text("0000000001101010", (width/2)+489, (height/2)+252);
    //T6 Finalizar
    //contador
    fill(fc6);
    pos = binary(6, 8);
    ...
    fill(fi6);
    text("FINALIZAR", (width/2)-138, (height/2)-363);
    fill(f52);
    //direccion
    ...
    case 33:
      fill(0);
      text("00010100", (width/2)-x37, (height/2)+y37);
      if (y37==376) {
        if (x37==-322) {
          moveT=240;
          opr=34;
    ...
    case 40:
      fill(0);
      text("00010101", (width/2)-x45, (height/2)+y45);
      if (y45==376) {
        if (x45==-322) {
          moveT=252;
          opr=41;
    ...
    case 42:
      fill(0);
      text("0000000001101010", (width/2)-g1, (height/2)+g2);
      if (g1==-276) {
        m1=0;
        opr=43;
      } else {
    ...
    case 48:
      fill(0);
      text("00000000", (width/2)-x53, (height/2)+y53);
      if (y53==376) {
        if (x53==-322) {
          moveT=0;
          opr=48;
